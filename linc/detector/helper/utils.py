...
class MetricLogger(object):
    def __init__(self, delimiter="\t", device='cuda'):
    ...
    def log_every(self, iterable, print_freq, header=None):
        ...
        for obj in iterable:
            ...
            if i % print_freq == 0 or i == len(iterable) - 1:
                ...
                memory = torch.cuda.max_memory_allocated() if self.device == 'cuda' else 0.0
...
def draw_boxes(image, boxes, labels, label_names, scores=None, vert_size=None, line_width=4,
    ...
    line_color = 'blue' if scores is None else 'red'
    text_color = 'blue' if scores is None else 'white'
    width = line_width if scores is None else max(int(line_width / 2), 1)
